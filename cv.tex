\usepackage{amsmath}\documentclass[12pt,a4paper,sans]{moderncv}        % possible options include font size ('10pt', '11pt' and '12pt'), paper size ('a4paper', 'letterpaper', 'a5paper', 'legalpaper', 'executivepaper' and 'landscape') and font family ('sans' and 'roman')
\usepackage{multicol}
\newcommand{\rom}[1]{%
...
\begin{itemize}
    ...
    \item Distributed and parallel systems
    \end{itemize}
}
\cvcolumn{}{
    \begin{itemize}
...
\cvcolumn{}{
    \begin{itemize}
        \item Rewrote Perl code to C++ and Python to improve codebase readability and overall health
        \item Wrote internal web service for storing data about news agencies
    \end{itemize}
}\end{cvcolumns}
...
\cvcolumn{}{
    \begin{itemize}
        ...
        \item Used PhantomJS with Selenium to render search pages.
    \end{itemize}
}\end{cvcolumns}
...
\cvitem{2016}{1st degree award in Physics and Mathematics Olympiad "PhysTech"}
\cvitem{2016}{3rd degree award in Mathematics Olympiad "Open Olympiad Lomonosov"}
